...
class ServiceHelper {
  ...
  // -->  Sync Servisler
  static SecureStorageManager get secureStorage => locator<SecureStorageManager>();
  static SharedPreferencesManager get sharedPrefs => locator<SharedPreferencesManager>();
  static DBService get dbService => locator<DBService>();

  // -->  Async Servisler
  static Future<BookRepository> get bookRepository => locator.getAsync<BookRepository>();
  static Future<LibraryRepository> get libraryRepository => locator.getAsync<LibraryRepository>();
  static Future<NumberOfBookRepository> get numberOfBookRepository => locator.getAsync<NumberOfBookRepository>();
  static Future<WriterRepository> get writerRepository => locator.getAsync<WriterRepository>();
